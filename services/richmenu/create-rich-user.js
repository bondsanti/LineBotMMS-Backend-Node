...
exports.createRichMenuUser = async () => {
  ...
  // 4. create alias to richmenu *ถ้าไม่อยากติดแคชให้สร้างชื่อใหม่
  await client.createRichMenuAlias(richMenuUserId, "richmenu-alias-user-3");
